...
plt.plot(x,y) #Bize x ve y verilerini kullanarak bir grafik oluşturacağımızı söyler
...
plt.hist(yeni_veri)  # Dağılım grafiğini çizdirir Unutmahisstogram grafiği tek veriyle çalışır
